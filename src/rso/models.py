...
class RSO(models.Model):
    ...
    rso_scheduled_dates_from    = models.DateField(default=None, blank=True, null=True, verbose_name="From")
    rso_scheduled_dates_to      = models.DateField(default=None, blank=True, null=True, verbose_name="To")
    ...
    rso_scan_copy               = models.FileField(upload_to=rso_upload_path, default=None, blank=False, null=False, verbose_name="Scanned Copy")

...
class RSO(models.Model):
    ...
    rso_scheduled_dates_from    = models.DateField(default=None, blank=False, null=False, verbose_name="Date From")
    rso_scheduled_dates_to      = models.DateField(default=None, blank=False, null=False, verbose_name="Date To")
